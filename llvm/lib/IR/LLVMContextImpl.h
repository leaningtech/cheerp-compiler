...
struct AnonStructTypeKeyInfo {
  struct KeyTy {
    ...
    KeyTy(const ArrayRef<Type *> &E, bool P, StructType* b) : ETypes(E), isPacked(P), directBase(b) {}
  ...
  static unsigned getHashValue(const KeyTy &Key) {
    return hash_combine(
        hash_combine_range(Key.ETypes.begin(), Key.ETypes.end()), Key.isPacked, Key.directBase);
  }
