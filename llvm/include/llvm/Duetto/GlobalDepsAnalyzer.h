//===-- Duetto/GlobalDepsAnalyzer.h - Duetto utility code ---------------------===//
//
...
#ifndef _DUETTO_GLOBAL_DEPS_ANALYZER_H
#define _DUETTO_GLOBAL_DEPS_ANALYZER_H
...
public:
	...
	/**
	 * Determine if we need to compile a duettoCreateClosure function
	 */
