//
// Created by c on 23-5-24.
//

#ifndef LLVM_WASMMCSTREAMER_H
#define LLVM_WASMMCSTREAMER_H
...
typedef llvm::MCWasmStreamer WasmBuffer;
...
private:
  ...
  public:
    ...
    {
      ///replace with the MCWasmStreamer functions
