...
enum TypeCodes {
  ...
  TYPE_CODE_STRUCT_ANON = 18, // STRUCT_ANON: [ispacked, bytelayout, asmjs, wasmgc, eltty x N]
  TYPE_CODE_STRUCT_NAME = 19,  // STRUCT_NAME: [strchr x N]
  TYPE_CODE_STRUCT_NAMED = 20,// STRUCT_NAMED: [ispacked, bytelayout, asmjs, wasmgc, eltty x N]
