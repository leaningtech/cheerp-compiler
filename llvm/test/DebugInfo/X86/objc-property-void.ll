...
@llvm.used = appending global [8 x i8*] [i8* bitcast ([4 x i8]* @"\01L_OBJC_CLASS_NAME_" to i8*), i8* bitcast ([4 x i8]* @"\01L_OBJC_METH_VAR_NAME_" to i8*), i8* bitcast ([8 x i8]* @"\01L_OBJC_METH_VAR_TYPE_" to i8*), i8* bitcast ({ i32, i32, [1 x %struct._objc_method] }* @"\01l_OBJC_$_INSTANCE_METHODS_Foo" to i8*), i8* bitcast ([4 x i8]* @"\01L_OBJC_PROP_NAME_ATTR_" to i8*), i8* bitcast ([7 x i8]* @"\01L_OBJC_PROP_NAME_ATTR_1" to i8*), i8* bitcast ({ i32, i32, [1 x %struct._prop_t] }* @"\01l_OBJC_$_PROP_LIST_Foo" to i8*), i8* bitcast ([1 x i8*]* @"\01L_OBJC_LABEL_CLASS_$" to i8*)], section "llvm.metadata"
