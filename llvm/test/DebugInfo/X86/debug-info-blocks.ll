...
@llvm.used = appending global [14 x i8*] [i8* bitcast (%struct._class_t** @"\01L_OBJC_CLASSLIST_SUP_REFS_$_" to i8*), i8* bitcast ([5 x i8]* @"\01L_OBJC_METH_VAR_NAME_" to i8*), i8* bitcast (i8** @"\01L_OBJC_SELECTOR_REFERENCES_" to i8*), i8* bitcast (%struct._class_t** @"\01L_OBJC_CLASSLIST_REFERENCES_$_" to i8*), i8* bitcast ([6 x i8]* @"\01L_OBJC_METH_VAR_NAME_1" to i8*), i8* bitcast ([6 x i8]* @"\01L_OBJC_METH_VAR_NAME_2" to i8*), i8* bitcast ([2 x i8]* @"\01L_OBJC_CLASS_NAME_" to i8*), i8* bitcast ([8 x i8]* @"\01L_OBJC_METH_VAR_TYPE_" to i8*), i8* bitcast ({ i32, i32, [1 x %struct._objc_method] }* @"\01l_OBJC_$_INSTANCE_METHODS_A" to i8*), i8* bitcast ([5 x i8]* @"\01L_OBJC_METH_VAR_NAME_3" to i8*), i8* bitcast ([2 x i8]* @"\01L_OBJC_METH_VAR_TYPE_4" to i8*), i8* bitcast ({ i32, i32, [1 x %struct._ivar_t] }* @"\01l_OBJC_$_INSTANCE_VARIABLES_A" to i8*), i8* bitcast (%struct._class_t** @"\01L_OBJC_CLASSLIST_REFERENCES_$_5" to i8*), i8* bitcast ([1 x i8*]* @"\01L_OBJC_LABEL_CLASS_$" to i8*)], section "llvm.metadata"
