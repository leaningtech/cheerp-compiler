...
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(128) [[DST:%.*]], i8* noundef nonnull align 1 dereferenceable(128) bitcast ([129 x i8]* @str.2 to i8*), i64 128, i1 false)
; CHECK-NEXT:    ret void
;
