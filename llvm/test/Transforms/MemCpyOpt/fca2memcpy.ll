...
; CHECK-LABEL: @copy(
; CHECK-NEXT:    call void @llvm.memmove.p0.p0.i32(ptr align 8 [[DST:%.*]], ptr align 8 [[SRC:%.*]], i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, ptr %src
  store %S %1, ptr %dst
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[DST:%.*]], ptr align 8 [[SRC:%.*]], i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, ptr %src
  store %S %1, ptr %dst
...
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 8 [[SRC]], i8 0, i32 16, i1 false)
...
; CHECK-NEXT:    call void @llvm.memmove.p0.p0.i32(ptr align 8 [[DST2]], ptr align 8 [[SRC:%.*]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 8 [[DST:%.*]], i8 undef, i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, ptr %src
...
; CHECK-NEXT:    [[DST2:%.*]] = getelementptr [[S:%.*]], ptr [[DST:%.*]], i32 [[DSTINDEX]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[DST2]], ptr align 8 [[SRC]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0.i32(ptr align 8 [[SRC:%.*]], i8 undef, i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, ptr %src
