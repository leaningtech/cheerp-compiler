...
; CHECK-NEXT:    call void @llvm.memmove.p0i8.p0i8.i32(i8* align 8 [[TMP1]], i8* align 8 [[TMP2]], i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
  store %S %1, %S* %dst
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast %S* [[DST:%.*]] to i8*
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast %S* [[SRC:%.*]] to i8*
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP1]], i8* align 8 [[TMP2]], i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
  store %S %1, %S* %dst
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast %S* [[SRC]] to i8*
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 8 [[TMP2]], i8 0, i32 16, i1 false)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP2]], i8* align 8 [[TMP3]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 8 [[TMP1]], i8 0, i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
  store %S zeroinitializer, %S* %src
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast %S* [[DST:%.*]] to i8*
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast %S* [[SRC]] to i8*
; CHECK-NEXT:    call void @llvm.memmove.p0i8.p0i8.i32(i8* align 8 [[TMP2]], i8* align 8 [[TMP3]], i32 16, i1 false)
; CHECK-NEXT:    store [[S]] [[TMP1]], %S* [[DST]], align 8
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
...
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast %S* [[SRC:%.*]] to i8*
; CHECK-NEXT:    call void @llvm.memmove.p0i8.p0i8.i32(i8* align 8 [[TMP2]], i8* align 8 [[TMP3]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 8 [[TMP1]], i8 undef, i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
  store %S undef, %S* %dst
...
; CHECK-NEXT:    [[TMP1:%.*]] = load [[S:%.*]], %S* [[SRC:%.*]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast %S* [[DST:%.*]] to i8*
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 8 [[TMP2]], i8 undef, i32 16, i1 false)
...
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 [[TMP3]], i8* align 8 [[TMP4]], i32 16, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 8 [[TMP1]], i8 undef, i32 16, i1 false)
; CHECK-NEXT:    ret void
;
  %1 = load %S, %S* %src
