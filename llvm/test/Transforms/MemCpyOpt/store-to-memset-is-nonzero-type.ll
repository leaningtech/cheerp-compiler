...
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 1 [[TMP1]], i8 undef, i32 0, i1 false)
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 1 [[TMP1]], i8 0, i32 1, i1 false)
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @llvm.memset.p0i8.i32(i8* align 16 [[TMP1]], i8 0, i32 32, i1 false)
; CHECK-NEXT:    ret void
;
