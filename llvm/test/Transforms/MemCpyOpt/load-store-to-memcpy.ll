...
; CHECK-NEXT:    call void @llvm.memmove.p0.p0.i32(ptr align 16 [[B:%.*]], ptr align 8 [[A:%.*]], i32 8, i1 false)
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 16 [[B:%.*]], ptr align 8 [[A:%.*]], i32 8, i1 false)
; CHECK-NEXT:    ret void
;
  %val = load %T, ptr %a, align 8
  store %T %val, ptr %b, align 16
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 16 [[D:%.*]], ptr align 8 @C, i32 8, i1 false)
; CHECK-NEXT:    ret void
;
