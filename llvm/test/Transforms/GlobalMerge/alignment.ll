...
define void @use() {
  ; CHECK: load i32, i32* bitcast ([5 x i8]* getelementptr inbounds (<{ [5 x i8], [3 x i8], [2 x i32] }>, <{ [5 x i8], [3 x i8], [2 x i32] }>* @_MergedGlobals, i32 0, i32 0) to i32*)
  %x = load i32, i32* bitcast ([5 x i8]* @a to i32*)
  ; CHECK: load i32, i32* bitcast ([2 x i32]* getelementptr inbounds (<{ [5 x i8], [3 x i8], [2 x i32] }>, <{ [5 x i8], [3 x i8], [2 x i32] }>* @_MergedGlobals, i32 0, i32 2) to i32*)
