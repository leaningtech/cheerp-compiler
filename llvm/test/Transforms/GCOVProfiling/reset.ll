...
; CHECK-NEXT: entry:
; CHECK-NEXT: call void @llvm.memset.p0i8.i32(i8* bitcast ([1 x i64]* @__llvm_gcov_ctr to i8*), i8 0, i32 8, i1 false)
; CHECK-NEXT: call void @llvm.memset.p0i8.i32(i8* bitcast ([1 x i64]* @__llvm_gcov_ctr.1 to i8*), i8 0, i32 8, i1 false)
