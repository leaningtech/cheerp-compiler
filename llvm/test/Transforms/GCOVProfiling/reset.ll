...
; CHECK-NEXT: entry:
; CHECK-NEXT: call void @llvm.memset.p0.i32(ptr @__llvm_gcov_ctr, i8 0, i32 8, i1 false)
; CHECK-NEXT: call void @llvm.memset.p0.i32(ptr @__llvm_gcov_ctr.1, i8 0, i32 8, i1 false)
