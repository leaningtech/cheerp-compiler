...
; ENTRY:   call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 0)
...
; NOTENTRY:   call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 1)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 2)
; CHECK:   br label %sw.bb2

; CHECK: entry.sw.bb2_crit_edge:
; NOTENTRY:   call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 0)
; TENTRY:   call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 1)
; CHECK:   br label %sw.bb2

sw.bb:
; GEN: sw.bb:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 5)
  %call = call i32 @bar(i32 2)
  br label %sw.epilog

sw.bb1:
; GEN: sw.bb1:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 4)
...
if.then:
; GEN: if.then:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 2)
...
if.end:
; GEN: if.end:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 3)
...
if.then8:
; GEN: if.then8:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 7)
  %add = add nsw i32 %call6, 10
  br label %if.end9

if.end9:
; GEN: if.end9:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([17 x i8]* @__profn_test_criticalEdge to i8*), i64 {{[0-9]+}}, i32 8, i32 6)
...
entry:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn__stdin__bar to i8*), i64 {{[0-9]+}}, i32 1, i32 0)
  ret i32 %i
}
