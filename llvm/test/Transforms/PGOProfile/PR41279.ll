...
; GEN: 6:
; GEN:  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 2)
...
12:
  ...
  br label %14
; GEN: 12:
; GEN:  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 1)

13:
  call void @f3({ i8*, i64 }* %0, { i8*, i64 }* %1, i64 1)
  br label %14
; GEN: 13:
; GEN:  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 0)
...
15:
  ...
  br label %6
; GEN: 15:
; GEN:  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 3)
