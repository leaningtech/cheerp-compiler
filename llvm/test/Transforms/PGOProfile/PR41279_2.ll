...
;GEN:  _except1:
;GEN:    call void @llvm.instrprof.increment(i8* bitcast ([1 x i8]* @__profn_f to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
...
invoke.cont3:
  br label %__try.cont7
;GEN: invoke.cont3:
;GEN:  call void @llvm.instrprof.increment(i8* bitcast ([1 x i8]* @__profn_f to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
