...
entry:
; GEN: entry:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_test_br_1 to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
...
if.then:
; GEN: if.then:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_test_br_1 to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
  %add = add nsw i32 %i, 2
  br label %if.end
