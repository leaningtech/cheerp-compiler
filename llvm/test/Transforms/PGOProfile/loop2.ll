...
entry:
; GEN: entry:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 2)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 0)
...
for.inc.inner:
; GEN: for.inc.inner:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 0)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 1)
...
for.inc.outer:
; GEN: for.inc.outer:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 1)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_nested_for to i8*), i64 {{[0-9]+}}, i32 3, i32 2)
