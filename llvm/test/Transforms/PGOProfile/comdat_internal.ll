...
; CHECK: @__profd__stdin__foo.[[FOO_HASH]] = private global { i64, i64, i64*, i8*, i8*, i32, [2 x i16] } { i64 -5640069336071256030, i64 [[FOO_HASH]], i64* bitcast ([1 x i64]* @__profc__stdin__foo.[[FOO_HASH]] to i64*), i8* null
