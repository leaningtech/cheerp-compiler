...
entry:
; GEN: entry:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_bar to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
  %rem = srem i32 %i, 3
...
if.then:
; GEN: if.then:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_bar to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
...
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 0)
  %rem = srem i32 %i, 2
  %tobool = icmp ne i32 %rem, 0
  br i1 %tobool, label %if.then, label %if.end
; USE: br i1 %tobool, label %if.then, label %if.end
...
if.end:
; GEN: if.end:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 {{[0-9]+}}, i32 4, i32 0)
