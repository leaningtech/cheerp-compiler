...
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn_test_switch to i8*), i64 {{[0-9]+}}, i32 4, i32 0)
...
sw.bb:
; GEN: sw.bb:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn_test_switch to i8*), i64 {{[0-9]+}}, i32 4, i32 2)
  br label %sw.epilog

sw.bb1:
; GEN: sw.bb1:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn_test_switch to i8*), i64 {{[0-9]+}}, i32 4, i32 0)
; ENTRY-NOT: call void @llvm.instrprof.increment
  br label %sw.epilog

sw.bb2:
; GEN: sw.bb2:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn_test_switch to i8*), i64 {{[0-9]+}}, i32 4, i32 1)
  br label %sw.epilog

sw.default:
; GEN: sw.default:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([11 x i8]* @__profn_test_switch to i8*), i64 {{[0-9]+}}, i32 4, i32 3)
  br label %sw.epilog
