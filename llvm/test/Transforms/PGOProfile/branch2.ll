...
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_test_br_2 to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
...
if.then:
; GEN: if.then:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_test_br_2 to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
...
if.else:
; GEN: if.else:
; GEN: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_test_br_2 to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
  %sub = sub nsw i32 %i, 2
  br label %if.end
