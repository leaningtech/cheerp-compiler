...
entry:
  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 29212902728, i32 2, i32 1)
  br label %for.cond
...
if.end:
  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 29212902728, i32 2, i32 0)
  call void (...) @bar2()
