...
; GEN: @foo()
; GEN: entry:
; GEN-NEXT: call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_foo to i8*), i64 [[#FOO_HASH:]], i32 1, i32 0)
...
; GEN: @vp_inline()
; GEN: entry:
; GEN-NEXT: call void @llvm.instrprof.increment(i8* bitcast ([9 x i8]* @__profn_vp_inline to i8*), i64 [[#FOO_HASH:]], i32 1, i32 0)
  %tmp = load void ()*, void ()** @bar, align 8
; GEN: [[ICALL_TARGET:%[0-9]+]] = ptrtoint void ()* %tmp to i64
; GEN-NEXT: call void @llvm.instrprof.value.profile(i8* bitcast ([9 x i8]* @__profn_vp_inline to i8*), i64 [[#FOO_HASH]], i64 [[ICALL_TARGET]], i32 0, i32 0)
