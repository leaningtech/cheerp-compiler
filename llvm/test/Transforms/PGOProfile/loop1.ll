...
entry:
; GEN: entry:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_simple_for to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_simple_for to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
  br label %for.cond
...
for.inc:
; GEN: for.inc:
; NOTENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_simple_for to i8*), i64 {{[0-9]+}}, i32 2, i32 0)
; ENTRY: call void @llvm.instrprof.increment(i8* bitcast ([15 x i8]* @__profn_test_simple_for to i8*), i64 {{[0-9]+}}, i32 2, i32 1)
