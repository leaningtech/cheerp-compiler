...
; AMDGPU: @[[GLOB2:[0-9]+]] = private unnamed_addr constant [[STRUCT_IDENT_T:%.*]] { i32 0, i32 2, i32 0, i32 22, i8* bitcast ([23 x i8]* @[[GLOB0]] to i8*) }, align 8
...
; NVPTX: @[[GLOB2:[0-9]+]] = private unnamed_addr constant [[STRUCT_IDENT_T:%.*]] { i32 0, i32 2, i32 0, i32 22, i8* bitcast ([23 x i8]* @[[GLOB0]] to i8*) }, align 8
...
; AMDGPU-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26:![0-9]+]]
; AMDGPU-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
...
; NVPTX-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26:![0-9]+]]
; NVPTX-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
...
; AMDGPU-DISABLED-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26:![0-9]+]]
; AMDGPU-DISABLED-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
...
; NVPTX-DISABLED-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26:![0-9]+]]
; NVPTX-DISABLED-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
...
; AMDGPU-NEXT:  entry:
; AMDGPU-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca [1 x i8*], align 8
; AMDGPU-NEXT:    [[X_ON_STACK:%.*]] = bitcast i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared.1 to i8 addrspace(3)*) to i8*) to i32*
...
; AMDGPU-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared.1 to i8 addrspace(3)*) to i8*), i8** [[TMP2]], align 8, !tbaa [[TBAA26]]
...
; NVPTX-NEXT:  entry:
; NVPTX-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca [1 x i8*], align 8
; NVPTX-NEXT:    [[X_ON_STACK:%.*]] = bitcast i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared1 to i8 addrspace(3)*) to i8*) to i32*
...
; NVPTX-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared1 to i8 addrspace(3)*) to i8*), i8** [[TMP2]], align 8, !tbaa [[TBAA26]]
...
; AMDGPU-DISABLED-NEXT:  entry:
; AMDGPU-DISABLED-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca [1 x i8*], align 8
; AMDGPU-DISABLED-NEXT:    [[X_ON_STACK:%.*]] = bitcast i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared.1 to i8 addrspace(3)*) to i8*) to i32*
...
; AMDGPU-DISABLED:       for.body:
; AMDGPU-DISABLED-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[CAPTURED_VARS_ADDRS]], i64 0, i64 0
; AMDGPU-DISABLED-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared.1 to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26]]
; AMDGPU-DISABLED-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
; AMDGPU-DISABLED-NEXT:    [[TMP2:%.*]] = bitcast [1 x i8*]* [[CAPTURED_VARS_ADDRS]] to i8**
...
; NVPTX-DISABLED-NEXT:  entry:
; NVPTX-DISABLED-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca [1 x i8*], align 8
; NVPTX-DISABLED-NEXT:    [[X_ON_STACK:%.*]] = bitcast i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared1 to i8 addrspace(3)*) to i8*) to i32*
...
; NVPTX-DISABLED:       for.body:
; NVPTX-DISABLED-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[CAPTURED_VARS_ADDRS]], i64 0, i64 0
; NVPTX-DISABLED-NEXT:    store i8* addrspacecast (i8 addrspace(3)* bitcast ([4 x i8] addrspace(3)* @x_shared1 to i8 addrspace(3)*) to i8*), i8** [[TMP0]], align 8, !tbaa [[TBAA26]]
; NVPTX-DISABLED-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4, !tbaa [[TBAA18]]
; NVPTX-DISABLED-NEXT:    [[TMP2:%.*]] = bitcast [1 x i8*]* [[CAPTURED_VARS_ADDRS]] to i8**
