...
; SSE-NEXT:    store <16 x i8> [[TMP4]], <16 x i8>* bitcast (i8* getelementptr inbounds ([32 x i8], [32 x i8]* @cle, i64 0, i64 0) to <16 x i8>*), align 16
; SSE-NEXT:    ret void
;
; AVX-LABEL: @splat(
...
; AVX-NEXT:    store <16 x i8> [[TMP4]], <16 x i8>* bitcast (i8* getelementptr inbounds ([32 x i8], [32 x i8]* @cle, i64 0, i64 0) to <16 x i8>*), align 16
; AVX-NEXT:    ret void
;
  %1 = xor i8 %c, %a
...
; AVX-NEXT:    store <4 x i32> [[TMP7]], <4 x i32>* bitcast (i32* getelementptr inbounds ([32 x i32], [32 x i32]* @cle32, i64 0, i64 0) to <4 x i32>*), align 16
; AVX-NEXT:    ret void
;
  %add1 = add i32 %c, %a
  %add2 = add i32 %c, %a
