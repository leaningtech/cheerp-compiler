...
; CHECK-NEXT:    store <2 x i16*> <i16* bitcast (%rec8* getelementptr inbounds ([1 x %rec8], [1 x %rec8]* @a, i16 0, i64 0) to i16*), i16* bitcast (%rec8* getelementptr inbounds ([1 x %rec8], [1 x %rec8]* @a, i16 0, i64 0) to i16*)>, <2 x i16*>* [[TMP4]], align 8
