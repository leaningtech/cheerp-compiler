...
; CHECK:       %a.Frame = type directbase %__coroFrameBase.{{.}} { void (%a.Frame*)*, void (%a.Frame*)*, %"struct.task::promise_type", %struct.big_structure, i1, [26 x i8], %struct.big_structure.2 }
