...
; CHECK: %foo.Frame = type directbase %__coroFrameBase.{{.}} { void (%foo.Frame*)*, void (%foo.Frame*)*, i1 }
; CHECK: %bar.Frame = type directbase %__coroFrameBase.{{.}} { void (%bar.Frame*)*, void (%bar.Frame*)*, i1 }
