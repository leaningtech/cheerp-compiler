...
; CHECK-NEXT:    ret <2 x i16*> <i16* bitcast (%rec8* getelementptr inbounds ([1 x %rec8], [1 x %rec8]* @a, i64 0, i64 0) to i16*), i16* bitcast (%rec8* getelementptr inbounds ([1 x %rec8], [1 x %rec8]* @a, i64 0, i64 0) to i16*)>
;
