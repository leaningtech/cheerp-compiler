...
define void @bar() {
  call void @llvm.instrprof.increment(i8* bitcast ([4 x i8]* @__profn_bar to i8*), i64 0, i32 1, i32 0)
  ret void
}
...
define void @baz() {
  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_baz to i8*), i64 0, i32 3, i32 0)
  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_baz to i8*), i64 0, i32 3, i32 1)
  call void @llvm.instrprof.increment(i8* bitcast ([3 x i8]* @__profn_baz to i8*), i64 0, i32 3, i32 2)
  ret void
}
