...
; NO-UAR-TAGS: call void @llvm.memset.p0.i32(ptr align 1 %[[X_SHADOW2]], i8 0, i32 1, i1 false)
; UAR-TAGS: call void @llvm.memset.p0.i32(ptr align 1 %[[X_SHADOW2]], i8 %[[X_TAG_UAR]], i32 1, i1 false)
; CHECK: ret void
