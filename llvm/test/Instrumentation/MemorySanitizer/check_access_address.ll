...
; CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 {{.*}}, i8* align 8 {{.*}}, i32 16, i1 false)
; CHECK: ret <2 x i64>
...
; CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 {{.*}}, i8* align 2 {{.*}}, i32 2, i1 false)
; CHECK: ret i16
