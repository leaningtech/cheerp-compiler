...
__func<_Fp, _Alloc, _Rp(_ArgTypes...)>::__clone() const
{
    ...
    ::new (__hold.get()) __func(__f_.__target(), _Alloc(__a));
    return __hold.release();
}
...
{
    ::new (static_cast<__func*>(__p)) __func(__f_.__target(), __f_.__get_allocator());
}
        ...
        : __f_(nullptr)
    {
        ...
        if (__function::__not_null(__f))
        {
...
#endif
            {
                ...
                ::new (__hold.get()) _Fun(_VSTD::move(__f), _Alloc(__a));
                __f_ = __hold.release();
            }
        }
    }
  ...
  private:
                           ...
                           __fast_forward<_ArgTypes>... __args)
    {
        ...
        _Fun* __f = reinterpret_cast<_Fun*>(__use_small_storage<_Fun>::value
                                                ...
                                                : __buf->__large);
#else
        _Fun* __f = reinterpret_cast<_Fun*>(__buf->__large);
#endif
...
#endif
{
    ...
    // This is needed to allow calling the constructor from genericjs when
    // std::function is in asmjs and vice-versa
#ifdef __ASMJS__
    struct _Dummy {};
    typedef _Dummy _void;
#else
    typedef void _void;
#endif

  template <class _Fp>
  using _EnableIfLValueCallable = typename enable_if<__callable<_Fp&>::value, _void>::type;
public:
