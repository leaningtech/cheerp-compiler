...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_bzero: {
    ...
    EmitNonNullArgCheck(RValue::get(Dest.getPointer()), E->getArg(0)->getType(),
                        E->getArg(0)->getExprLoc(), FD, 0);
    Builder.CreateMemSet(Dest, Builder.getInt8(0), SizeVal, false, getTarget().isByteAddressable());
    return RValue::get(nullptr);
  }
  ...
  case Builtin::BI__builtin_mempcpy: {
    ...
    Address Src = EmitPointerWithAlignment(SrcE);
    Value *SizeVal = EmitScalarExpr(E->getArg(2));
    EmitNonNullArgCheck(RValue::get(Dest.getPointer()), E->getArg(0)->getType(),
                        E->getArg(0)->getExprLoc(), FD, 0);
    EmitNonNullArgCheck(RValue::get(Src.getPointer()), E->getArg(1)->getType(),
                        E->getArg(1)->getExprLoc(), FD, 1);
    Builder.CreateMemCpy(Dest, Src, SizeVal, false, getTarget().isByteAddressable());
  ...
  case Builtin::BI__builtin_memmove: {
    ...
    EmitNonNullArgCheck(RValue::get(Src.getPointer()), E->getArg(1)->getType(),
                        E->getArg(1)->getExprLoc(), FD, 1);
    Builder.CreateMemMove(Dest, Src, SizeVal, false, getTarget().isByteAddressable());
    return RValue::get(Dest.getPointer());
  }
  ...
  case Builtin::BI__builtin_memset: {
    ...
    EmitNonNullArgCheck(RValue::get(Dest.getPointer()), E->getArg(0)->getType(),
                        E->getArg(0)->getExprLoc(), FD, 0);
    Builder.CreateMemSet(Dest, ByteVal, SizeVal, false, getTarget().isByteAddressable());
    return RValue::get(Dest.getPointer());
  }
  ...
  case Builtin::BI__sync_lock_release_16: {
    ...
    Ptr = Builder.CreateBitCast(Ptr, ITy->getPointerTo(Ptr->getType()->getPointerAddressSpace()));
    llvm::StoreInst *Store =
...
Value *CodeGenFunction::EmitCheerpBuiltinExpr(unsigned BuiltinID,
  ...
  else if (BuiltinID == Cheerp::BI__builtin_cheerp_downcast) {
    llvm::Type *Tys[] = { ConvertType(E->getType()), Ops[0]->getType() };
  ...
  else if (BuiltinID == Cheerp::BI__builtin_cheerp_grow_memory) {
  ...
  else if (BuiltinID == Cheerp::BI__builtin_wasm_any_true_v128) {
    Value *Vec = EmitScalarExpr(E->getArg(0));
  ...
  else if (BuiltinID == Cheerp::BI__builtin_wasm_popcnt_i8x16) {
    Value *Vec = EmitScalarExpr(E->getArg(0));
    Function *Callee =
  ...
  else if (BuiltinID == Cheerp::BI__builtin_wasm_avgr_u_i8x16 ||
            BuiltinID == Cheerp::BI__builtin_wasm_avgr_u_i16x8) {
    Value *LHS = EmitScalarExpr(E->getArg(0));
    Value *RHS = EmitScalarExpr(E->getArg(1));
