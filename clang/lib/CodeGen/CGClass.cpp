...
void CodeGenFunction::InitializeVTablePointer(const VPtr &Vptr) {
  ...
  if (!getTarget().isByteAddressable()) {
    ...
    VTableField = Address(Builder.CreateGEP(VTableField.getElementType(), VTableField.getPointer(), GEPConstantIndexes), CGM.getTypes().GetVTableBaseType(asmjs)->getPointerTo(VTableField.getType()->getPointerAddressSpace()), VTableField.getAlignment());
