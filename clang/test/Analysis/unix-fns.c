...
// RUN: mkdir -p %t.dir
// RUN: %clang_analyze_cc1 -triple %itanium_abi_triple -analyzer-checker=core,unix.API,osx.API,optin.portability -analyzer-output=html -analyzer-config faux-bodies=true -fblocks -o %t.dir %s
// RUN: rm -fR %t.dir
