// RUN: %clang_analyze_cc1 -triple %itanium_abi_triple -std=c++11 -Wno-conversion-null -analyzer-checker=core,debug.ExprInspection -analyzer-store region -analyzer-output=text -verify %s
