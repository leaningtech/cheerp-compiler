...
// RUN: %clang_cc1 -triple %itanium_abi_triple -x c -ffixed-point -ast-dump %s | FileCheck %s --strict-whitespace
//
// Test with serialization:
// RUN: %clang_cc1 -triple %itanium_abi_triple -ffixed-point -emit-pch -o %t %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -x c -ffixed-point -include-pch %t -ast-dump-all /dev/null \
