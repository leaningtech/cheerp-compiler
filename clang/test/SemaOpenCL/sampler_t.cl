// RUN: %clang_cc1 -triple %itanium_abi_triple %s -verify -pedantic -fsyntax-only
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -verify -pedantic -fsyntax-only -DCHECK_SAMPLER_VALUE -Wspir-compat -triple amdgcn--amdhsa
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -verify -pedantic -fsyntax-only -DCHECK_SAMPLER_VALUE -Wspir-compat -triple spir-unknown-unknown
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -cl-std=CL2.0 -verify -pedantic -fsyntax-only
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -cl-std=CL2.0 -verify -pedantic -fsyntax-only -DCHECK_SAMPLER_VALUE -Wspir-compat -triple amdgcn--amdhsa
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -cl-std=CL2.0 -verify -pedantic -fsyntax-only -DCHECK_SAMPLER_VALUE -Wspir-compat -triple spir-unknown-unknown
