...
// RUN: %clang_cc1 -triple %itanium_abi_triple -x c++ -std=c++11 -fmodules -fimplicit-module-maps -fmodule-name=b -o %t/b.pcm \
// RUN:     -emit-module %S/Inputs/merge-vtable-codegen/merge-vtable-codegen.modulemap \
// RUN:     -I %S/Inputs/merge-vtable-codegen
// RUN: %clang_cc1 -triple %itanium_abi_triple -x c++ -std=c++11 -fmodules -fimplicit-module-maps -fmodule-name=c -o %t/c.pcm \
// RUN:     -emit-module %S/Inputs/merge-vtable-codegen/merge-vtable-codegen.modulemap \
// RUN:     -I %S/Inputs/merge-vtable-codegen

// Use the two modules in a single compile.
// RUN: %clang_cc1 -triple %itanium_abi_triple -x c++ -std=c++11 -fmodules -fimplicit-module-maps -fmodule-file=%t/b.pcm -fmodule-file=%t/c.pcm \
