// RUN: rm -rf %t
// RUN: %clang_cc1 -triple %itanium_abi_triple -debug-info-kind=limited -fmodules \
...
// RUN: %clang_cc1 -triple %itanium_abi_triple -debug-info-kind=limited -fmodules -fimplicit-module-maps \
