...
// Modules:
// RUN: %clang_cc1 -triple %itanium_abi_triple -x objective-c -debug-info-kind=limited -dwarf-ext-refs -fmodules \
...
// PCH:
// RUN: %clang_cc1 -triple %itanium_abi_triple -x objective-c -fmodule-format=obj -emit-pch -I%S/Inputs \
// RUN:     -o %t.pch %S/Inputs/DebugObjC.h
// RUN: %clang_cc1 -triple %itanium_abi_triple -x objective-c -debug-info-kind=limited -dwarf-ext-refs \
