// RUN: %clang_cc1 -triple %itanium_abi_triple -verify=expected        -Warray-bounds-pointer-arithmetic %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -verify=expected        -Warray-bounds-pointer-arithmetic %s -fstrict-flex-arrays=0
// RUN: %clang_cc1 -triple %itanium_abi_triple -verify=expected,strict -Warray-bounds-pointer-arithmetic %s -fstrict-flex-arrays=2
// RUN: %clang_cc1 -triple %itanium_abi_triple -verify=expected,strict -Warray-bounds-pointer-arithmetic %s -fstrict-flex-arrays=3
