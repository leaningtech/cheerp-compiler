...
// HOST: @.omp_offloading.entry.c_decl_tgt_ref_ptr = weak constant %struct.__tgt_offload_entry { i8* bitcast (i32** @c_decl_tgt_ref_ptr to i8*), i8* bitcast ([{{[0-9]+}} x i8]* @.omp_offloading.entry_name to i8*), i64 8, i32 1, i32 0 }, section "omp_offloading_entries", align 1
...
// HOST: @.omp_offloading.entry.[[D_PTR]] = weak constant %struct.__tgt_offload_entry { i8* bitcast (i32** @[[D_PTR]] to i8*), i8* bitcast ([{{[0-9]+}} x i8]* @.omp_offloading.entry_name{{.*}} to
