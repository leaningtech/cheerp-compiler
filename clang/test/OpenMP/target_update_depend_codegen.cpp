...
void foo(int arg) {
  ...
  // CK1-64: call void @llvm.memcpy.p0i8.p0i8.i[[sz]](i8* align 8 [[BC_PRIVS_SIZES]], i8* align {{8|4}} bitcast (i64* getelementptr inbounds ([1 x i64], [1 x i64]* [[SIZE00]], i32 0, i32 0) to i8*), i[[sz]] 8, i1 false)
  ...
  // CK1-32: call void @llvm.memcpy.p0i8.p0i8.i[[sz]](i8* align 4 [[BC_PRIVS_SIZES]], i8* align 4 bitcast (i64* getelementptr inbounds ([1 x i64], [1 x i64]* [[SIZE00]], i32 0, i32 0) to i8*), i[[sz]] 8, i1 false)
