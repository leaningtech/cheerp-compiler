...
// CHECK-DAG: @_ZTV7Derived = linkonce_odr protected unnamed_addr constant {{.*}} { [3 x ptr] [ptr null, ptr null, ptr @_ZN7Derived3fooEv] }
// CHECK-DAG: @_ZTV4Base = linkonce_odr protected unnamed_addr constant {{.*}} zeroinitializer
// CHECK-NOT: class_type_info
class Base {
  public:
  virtual void foo() = 0;
