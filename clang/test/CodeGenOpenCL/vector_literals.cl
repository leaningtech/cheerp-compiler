// RUN: %clang_cc1 -triple %itanium_abi_triple -no-opaque-pointers -emit-llvm %s -o - -O0 | FileCheck %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -no-opaque-pointers -emit-llvm %s -o - -cl-std=clc++ -O0 | FileCheck %s
