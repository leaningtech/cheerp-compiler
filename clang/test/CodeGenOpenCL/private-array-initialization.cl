...
// PRIVATE0:  %[[arr_i8_ptr:[0-9]+]] = bitcast
// PRIVATE0:  call void @llvm.memcpy.p0i8.p2i8.i32(i8* align 4 %[[arr_i8_ptr]], i8 addrspace(2)* align 4 bitcast (i32 addrspace(2)* getelementptr inbounds ([3 x i32], [3 x i32] addrspace(2)* @__const.test.arr, i32 0, i32 0) to i8 addrspace(2)*), i32 12, i1 false)

// PRIVATE5: %arr = alloca [3 x i32], align 4, addrspace(5)
// PRIVATE5: %0 = getelementptr
// PRIVATE5: call void @llvm.memcpy.p5i8.p4i8.i64(i8 addrspace(5)* align 4 %1, i8 addrspace(4)* align 4 bitcast (i32 addrspace(4)* getelementptr inbounds ([3 x i32], [3 x i32] addrspace(4)* @__const.test.arr, i64 0, i64 0) to i8 addrspace(4)*), i64 12, i1 false)
}

__kernel void initializer_cast_is_valid_crash() {
// PRIVATE0: %v512 = alloca [64 x i8], align 1
// PRIVATE0: %0 = getelementptr
