/* RUN: %clang_cc1 -triple %itanium_abi_triple -std=c89 -pedantic -verify -emit-llvm -o -  %s | FileCheck %s
   RUN: %clang_cc1 -triple %itanium_abi_triple -std=c99 -pedantic -verify -emit-llvm -o -  %s | FileCheck %s
