// RUN: %clang_cc1 -triple %itanium_abi_triple %s -std=c++11 -emit-llvm -o - | FileCheck %s
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -std=c++11 -emit-pch -o %t
// RUN: %clang_cc1 -triple %itanium_abi_triple %s -std=c++11 -include-pch %t -emit-llvm -o - | FileCheck %s
