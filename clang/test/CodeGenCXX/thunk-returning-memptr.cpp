...
// CHECK-LABEL: define linkonce_odr void @_ZThn4_N1C1fEv(%memberptr* noalias sret(%memberptr) align 4 %agg.result, %struct.C* noundef %this)
// CHECK: tail call void @_ZN1C1fEv(%memberptr* sret(%memberptr) align 4 %agg.result
