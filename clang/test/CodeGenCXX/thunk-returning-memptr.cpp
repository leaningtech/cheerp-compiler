...
// CHECK-LABEL: define linkonce_odr void @_ZThn4_N1C1fEv(%memberptr* noalias sret align 4 %agg.result, %struct.C* %this)
// CHECK: tail call void @_ZN1C1fEv(%memberptr* sret align 4 %agg.result
