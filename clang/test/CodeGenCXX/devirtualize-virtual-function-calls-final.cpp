...
namespace Test5 {
  ...
  void f(C* d) {
    ...
    // CHECK-NEXT: %[[FUNCTMP3:.*]] = getelementptr inbounds void (%"struct.Test5::A"*)*, void (%"struct.Test5::A"*)** %[[FUNCTMP2]], i64 0
    // CHECK-NEXT: %[[FUNC:.*]] = load void (%"struct.Test5::A"*)*, void (%"struct.Test5::A"*)** %[[FUNCTMP3]]
