...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTV1A, i32 0, inrange i32 0, i32 2)
...
// CHECK: call void @_ZN4BaseC2Ev(
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTV1B, i32 0, inrange i32 0, i32 2)
// CHECK: call void @_ZN5FieldC1Ev
// CHECK: ret void
