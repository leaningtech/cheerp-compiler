...
// CHECK: @_ZTV1S = linkonce_odr dso_local unnamed_addr constant {{.*}} { [3 x ptr] [ptr null, ptr @_ZTI1S, ptr @_ZN1S4testEv] }
...
// CHECK:   store ptr getelementptr inbounds ({{.*}}, ptr @_ZTV1S, i32 0, inrange i32 0, i32 2), ptr %{{[.0-9A-Z_a-z]+}}

// CHECK-LABEL: define linkonce_odr dso_local x86_thiscallcc void @_ZN1IC2Ev(ptr {{[^,]*}} %this)
// CHECK:   store ptr getelementptr inbounds ({{.*}}, ptr @_ZTV1I, i32 0, inrange i32 0, i32 2), ptr %{{[.0-9A-Z_a-z]+}}
