...
struct __declspec(dllexport) B : virtual A {
  virtual void f() = 0;
  // MANGLING-DAG: @"??_7B@Test13@@6B@" = weak_odr dllexport unnamed_addr constant {{.*}} { [1 x ptr] [ptr @_purecall] }
};
}
...
// MANGLING-DAG: @"??_7C@pr21031_1@@6BB@1@@" = {{.*}} constant {{.*}}
// MANGLING-DAG: @"??_7C@pr21031_1@@6B@" = {{.*}} constant {{.*}}
}
...
// MANGLING-DAG: @"??_7C@pr21031_2@@6BA@1@@" = {{.*}} constant {{.*}}
// MANGLING-DAG: @"??_7C@pr21031_2@@6BB@1@@" = {{.*}} constant {{.*}}
}
...
// MANGLING-DAG: @"??_7D@pr21062_1@@6B@" = {{.*}} constant {{.*}}
}
...
// MANGLING-DAG: @"??_7D@pr21062_2@@6B@" = {{.*}} constant {{.*}}
}
...
// MANGLING-DAG: @"??_7D@pr21064@@6B@" = {{.*}} constant {{.*}}
}
