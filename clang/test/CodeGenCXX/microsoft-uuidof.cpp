...
// CHECK: @gp = global %struct._GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }, { i32, i16, i16, [8 x i8] }* @_GUID_12345678_1234_1234_1234_1234567890ab, i32 0, i32 0) to %struct._GUID*), align 4
...
void gun() {
  ...
  // CHECK: store %struct._GUID* bitcast (i32* getelementptr inbounds ({ i32, i16, i16, [8 x i8] }, { i32, i16, i16, [8 x i8] }* @_GUID_00000000_0000_0000_0000_000000000000, i32 0, i32 0) to %struct._GUID*), %struct._GUID** %zeroiid, align 4
  const GUID& zeroiid = __uuidof(0);
}
