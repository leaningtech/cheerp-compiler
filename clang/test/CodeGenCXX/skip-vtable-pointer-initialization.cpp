...
// CHECK-NOT: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test11AE, i64 0, i64 2), ptr
A::~A() 
{
}
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test21AE, i32 0, inrange i32 0, i32 2), ptr
A::~A() {
  f();
}
...
// CHECK-NOT: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test31AE, i32 0, inrange i32 0, i32 2), ptr
A::~A() {
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test41AE, i32 0, inrange i32 0, i32 2), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test51AE, i32 0, inrange i32 0, i32 2), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test61AE, i32 0, inrange i32 0, i32 2), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test71AE, i32 0, inrange i32 0, i32 2), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds ({{.*}}, ptr @_ZTVN5Test81AE, i32 0, inrange i32 0, i32 2), ptr
A::~A()
{
}
