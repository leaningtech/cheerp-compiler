...
// CHECK-DAG: @_ZN7PR180978constant1aE = local_unnamed_addr global %{{.*}} <{ i16 1, i8 6, i8 undef }>, align 4
// CHECK-DAG: @_ZN7PR180978constant1bE = local_unnamed_addr global %{{.*}} <{ i16 2, i8 6, i8 undef }>, align 4
// CHECK-DAG: @_ZN7PR180978constant1cE = local_unnamed_addr global %{{.*}} <{ i16 3, i8 6, i8 undef }>, align 4
// CHECK-DAG: @_ZN7PR180978constant1yE = local_unnamed_addr global %{{.*}} { %{{.*}} <{ i16 4, i8 6, i8 undef }>, i32 5 }, align 4
