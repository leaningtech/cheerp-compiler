...
// CHECK: @llvm.used = appending global [7 x i8*] [i8* bitcast (i32* @"?x1@selectany_init@@3HA" to i8*), i8* bitcast (i32* @"?x@?$A@H@explicit_template_instantiation@@2HA" to i8*), i8* bitcast (i32* @"?ioo@?$X_@H@@2HA" to i8*), i8* bitcast (%struct.A* @"?aoo@S1@@2UA@@A" to i8*), i8* bitcast (i32* @"?zoo@@3HA" to i8*), i8* bitcast (%struct.S* @"?s@?$ExportedTemplate@H@@2US@@A" to i8*), i8* bitcast (i32* @"?x@?$A@H@implicit_template_instantiation@@2HA" to i8*)], section "llvm.metadata"
