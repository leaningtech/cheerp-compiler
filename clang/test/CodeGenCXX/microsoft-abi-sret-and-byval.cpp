...
// WIN32:   %[[a:[^ ]*]] = getelementptr inbounds [[argmem_ty:<{ void \(\)\*, %struct.SmallWithDtor }>]], [[argmem_ty:<{ void \(\)\*, %struct.SmallWithDtor }>]]* %{{.*}}, i32 0, i32 0
// WIN32:   %[[a1:[^ ]*]] = bitcast void ()** %[[a]] to void [[dst_ty:\(%struct.ForwardDeclare1\*\)\*]]*
...
// WIN32:   %[[addr:[^ ]*]] = bitcast void ()** %[[gep2]] to void [[dst_ty]]*
