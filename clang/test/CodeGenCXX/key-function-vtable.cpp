...
// CHECK-DAG: @_ZTV5testa ={{.*}} unnamed_addr constant {{.*}} { [3 x ptr] [ptr null
// CHECK-DAG: @_ZTV5testc = linkonce_odr unnamed_addr constant {{.*}} { [3 x ptr] [ptr null
// CHECK-DAG: @_ZTV5testb = linkonce_odr unnamed_addr constant {{.*}} { [3 x ptr] [ptr null
// CHECK-DAG: @_ZTV5teste = linkonce_odr unnamed_addr constant {{.*}} { [3 x ptr] [ptr null
// CHECK-DAG: @_ZTVN12_GLOBAL__N_15testgE = internal unnamed_addr constant {{.*}} { [3 x ptr] [ptr null
