...
// ITANIUM-DAG: @_ZTV1A = {{.*}} constant {{.*}} {{.*}} null, {{.*}} @_ZTI1A
// MSABI-DAG: @[[A_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4A@@6B@"
struct A {
...
// ITANIUM-DAG: @_ZTV1B = {{.*}} constant {{.*}} {{.*}} null, ptr @_ZTI1B, ptr @_ZN1B1fEv, ptr @_ZN1B1hEv
// MSABI-DAG: @[[B_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4B@@6B@", ptr @"?f@B@@UEAAXXZ", ptr @"?h@B@@UEAAXXZ"
struct B {
  virtual void f() {}
...
// ITANIUM-DAG: @_ZTV1C = {{.*}} constant {{.*}} {{.*}} null, ptr @_ZTI1C, ptr @_ZN1CD1Ev, ptr @_ZN1CD0Ev
// MSABI-DAG: @[[C_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4C@@6B@", ptr @"??_GC@@UEAAPEAXI@Z"
struct C {
  virtual ~C() = default;
...
// ITANIUM-DAG: @_ZTV1D = {{.*}} constant {{.*}} {{.*}} null, ptr @_ZTI1D, ptr @_ZN1DD1Ev, ptr @_ZN1DD0Ev
// MSABI-DAG: @[[D_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4D@@6B@", ptr @"??_GD@@UEAAPEAXI@Z"
struct D : C {};
// ITANIUM-DAG: @d = {{.*}}global { ptr } { {{.*}} @_ZTV1D,
// MSABI-DAG: @"?d@@3UD@@A" = {{.*}}global { ptr } { ptr @"??_7D@@6B@" }
D d;

// ITANIUM-DAG: @_ZTV1E = {{.*}} constant {{.*}} {{.*}} null, ptr @_ZTI1E, ptr @_ZN1E1fEv
// MSABI-DAG: @[[E_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4E@@6B@", ptr @"?f@E@@UEAAXXZ"
struct E { virtual void f() {} };
// ITANIUM-DAG: @e = {{.*}}global %struct.E { {{.*}} @_ZTV1E,
// MSABI-DAG: @"?e@@3UE@@A" = {{.*}}global %struct.E { ptr @"??_7E@@6B@" }
E e;

// ITANIUM-DAG: @_ZTV1F = {{.*}} constant {{.*}} {{.*}} null, ptr @_ZTI1F, ptr @_ZN1E1fEv
// MSABI-DAG: @[[F_VFTABLE:.*]] = {{.*}} constant {{.*}} {{.*}} @"??_R4F@@6B@", ptr @"?f@E@@UEAAXXZ"
