...
// PATTERN-O1: call void @llvm.memset{{.*}}({{.*}}i8 [[I8]], i32 10
...
// PATTERN-O1: getelementptr
// PATTERN-O1: call void @llvm.memset.p0i8.i32(i8* nonnull align 1 dereferenceable(10) %0, i8 [[I8]], i32 10, i1 false
...
// PATTERN-O1:  call void @llvm.memset.p0i8.i32(i8* nonnull align 16  dereferenceable(32) %{{[0-9*]}}, i8 -86, i32 32, i1 false)
...
// PATTERN-O1: bitcast
// PATTERN-O1: call void @llvm.memset{{.*}}({{.*}}, i8 [[I8]], i32 32
