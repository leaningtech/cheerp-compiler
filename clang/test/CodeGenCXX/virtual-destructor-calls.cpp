...
// CHECK-LABEL: define void @_ZN1BD2Ev(%struct._Z1B* %this) unnamed_addr
// CHECK: call void @_ZN6MemberD1Ev
// CHECK: call void @_ZN1AD2Ev

// Deleting dtor: defers to the complete dtor.
// CHECK-LABEL: define void @_ZN1BD0Ev(%struct._Z1B* %this) unnamed_addr
...
// Deleting dtor: defers to the complete dtor.
// CHECK-LABEL: define void @_ZN1CD0Ev(%struct._Z1C* %this) unnamed_addr
