...
//CHECK: @[[ARGS2:.*]] = private unnamed_addr constant { %struct.Struct } { %struct.Struct { i32* getelementptr inbounds ([2 x i32], [2 x i32]* @_ZN1AIjLj9EE2SVE, i32 0, i32 0), i32* getelementptr inbounds ([2 x i32], [2 x i32]* @_ZN1AIjLj9EE2SVE, i32 0, i32 1) } }, section "llvm.metadata"
//CHECK: @llvm.global.annotations = appending global [2 x { i8*, i8*, i8*, i32, i8* }] [{ i8*, i8*, i8*, i32, i8* } { i8* bitcast (void (%struct.A*)* @_ZN1AIjLj9EE4testILi8EEEvv to i8*), i8* bitcast ([5 x i8]* @[[STR:.*]] to i8*), i8* bitcast ([{{.*}} x i8]* @[[STR1:.*]] to i8*), i32 {{.*}}, i8* bitcast ({ i32, i8*, i32 }* @[[ARGS:.*]] to i8*) }, { i8*, i8*, i8*, i32, i8* } { i8* bitcast (void (%struct.A*)* @_ZN1AIjLj9EE5test2Ev to i8*), i8* bitcast ([5 x i8]* @.str.6 to i8*), i8* bitcast ([{{.*}} x i8]* @.str.1 to i8*), i32 24, i8* bitcast ({ %struct.Struct }* @[[ARGS2]] to i8*) }]
...
// CHECK-NEXT:    [[TMP2:%.*]] = call i8* @llvm.ptr.annotation.p0i8(i8* [[TMP1]], i8* bitcast ([8 x i8]* @.str to i8*), i8* bitcast ([{{.*}} x i8]* @.str.1 to i8*), i32 {{.*}}, i8* bitcast ({ i8*, i32, i32 }* @.args to i8*))
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast i8* [[TMP2]] to i32*
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast i32* [[TMP3]] to i8*
// CHECK-NEXT:    [[TMP5:%.*]] = call i8* @llvm.ptr.annotation.p0i8(i8* [[TMP4]], i8* bitcast ([8 x i8]* @.str.3 to i8*), i8* bitcast ([{{.*}} x i8]* @.str.1 to i8*), i32 {{.*}}, i8* bitcast ({ i32 }* @.args.4 to i8*))
...
// CHECK-NEXT:    [[TMP8:%.*]] = call i8* @llvm.ptr.annotation.p0i8(i8* bitcast (i32* getelementptr inbounds (%"struct.B<long, -1>::foo", %"struct.B<long, -1>::foo"* @_ZL2gf, i32 0, i32 0) to i8*), i8* bitcast ([8 x i8]* @.str to i8*), i8* bitcast ([{{.*}} x i8]* @.str.1 to i8*), i32 {{.*}}, i8* bitcast ({ i8*, i32, i64 }* @.args.5 to i8*))
// CHECK-NEXT:    [[TMP9:%.*]] = bitcast i8* [[TMP8]] to i32*
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[TMP9]] to i8*
// CHECK-NEXT:    [[TMP11:%.*]] = call i8* @llvm.ptr.annotation.p0i8(i8* [[TMP10]], i8* bitcast ([8 x i8]* @.str.3 to i8*), i8* bitcast ([{{.*}} x i8]* @.str.1 to i8*), i32 {{.*}}, i8* bitcast ({ i32 }* @.args.4 to i8*))
