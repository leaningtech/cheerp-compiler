...
// CHECK: define void @_ZN1C4bar1Ev(%class._Z1C* %this) unnamed_addr [[NUW]] align 2
void C::bar1() { }

// CHECK: define void @_ZN1C4bar2Ev(%class._Z1C* %this) unnamed_addr [[NUW]] align 2
void C::bar2() { }

// CHECK: define void @_ZN1C4bar3Ev(%class._Z1C* %this) unnamed_addr [[NUW]] align 1024
void C::bar3() { }

// CHECK: define void @_ZN1C4bar4Ev(%class._Z1C* %this) [[NUW]] align 1024
void C::bar4() { }
