...
// CHECK-32: @_ZTV1A ={{.*}} unnamed_addr constant {{.*}} { [5 x ptr] [ptr null, ptr @_ZTI1A, ptr @_ZN1A1fEv, ptr @_ZN1A1gEv, ptr @_ZN1A1hEv] }, align 4
...
// CHECK-64: @_ZTV1A ={{.*}} unnamed_addr constant {{.*}} { [5 x ptr] [ptr null, ptr @_ZTI1A, ptr @_ZN1A1fEv, ptr @_ZN1A1gEv, ptr @_ZN1A1hEv] }, align 8
