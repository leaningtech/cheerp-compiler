...
// CHECK: define {{.*}} @_Z1fIA2_sEvv() [[NUW:#[0-9]+]] personality i8* bitcast (void ()* @__gxx_personality_v0 to i8*) {
...
// CHECK: define {{.*}} @_Z1fIA2_DsEvv() [[NUW]] comdat personality i8* bitcast (void ()* @__gxx_personality_v0 to i8*) {
...
void h() {
  // CHECK: define {{.*}} @_Z1fIiEvv() [[NUW]] comdat personality i8* bitcast (void ()* @__gxx_personality_v0 to i8*) {
  f<int>();
  ...
  // CHECK: define {{.*}} @_Z1fIfEvv() [[NUW]] comdat  personality i8* bitcast (void ()* @__gxx_personality_v0 to i8*) {
  void (*f1)() = &f<float>;
  ...
  // CHECK: define {{.*}} @_Z1fIA4_cEvv() [[NUW]] comdat personality i8* bitcast (void ()* @__gxx_personality_v0 to i8*) {
  (void)&f<char[4]>;
