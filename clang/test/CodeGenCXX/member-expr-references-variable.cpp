...
// CHECK: call void @_Z3useiPKc(i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @[[STR]], i32 0, i32 0))
  use(3, ptr->name);
// CHECK: load %struct._Z6Struct*, %struct._Z6Struct** %{{.*}}, align 8
...
// CHECK: call void @_Z3useiPKc(i32 4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @[[STR]], i32 0, i32 0))
  use(5, Struct(2).name);
// CHECK: call void @_ZN6StructC1Ei(%struct._Z6Struct* %{{.*}}, i32 2)
// CHECK: call void @_Z3useiPKc(i32 5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @[[STR]], i32 0, i32 0))
  use(6, getPtr()->name);
// CHECK: call %struct._Z6Struct* @_Z6getPtrv()
...
// CHECK: %[[cast0:.*]] = bitcast %complex._ZTSf* %[[coerce0]] to <2 x float>*
...
// CHECK: %[[cast1:.*]] = bitcast %complex._ZTSf* %[[coerce1]] to <2 x float>*
...
// CHECK: %[[cast2:.*]] = bitcast %complex._ZTSf* %[[coerce2]] to <2 x float>*
...
// CHECK: %[[cast3:.*]] = bitcast %complex._ZTSf* %[[coerce3]] to <2 x float>*
...
// CHECK: %[[cast4:.*]] = bitcast %complex._ZTSf* %[[coerce4]] to <2 x float>*
...
// CHECK: %[[cast5:.*]] = bitcast %complex._ZTSf* %[[coerce5]] to <2 x float>*
...
void aggregateRefInMemberExpr(Struct *ptr, Struct &ref) {
  use(1, Struct::agg.x);
// CHECK: %[[value0:.*]] = load i8*, i8** getelementptr inbounds (%struct._Z3Agg, %struct._Z3Agg* @_ZGRN6Struct3aggE_, i32 0, i32 0), align 8
// CHECK: call void @_Z3useiPKc(i32 1, i8* %[[value0]])
  Struct s;
  use(2, s.agg.x);
// CHECK: %[[value1:.*]] = load i8*, i8** getelementptr inbounds (%struct._Z3Agg, %struct._Z3Agg* @_ZGRN6Struct3aggE_, i32 0, i32 0), align 8
// CHECK: call void @_Z3useiPKc(i32 2, i8* %[[value1]])
  use(3, ptr->agg.x);
// CHECK: load %struct._Z6Struct*, %struct._Z6Struct** %{{.*}}, align 8
// CHECK: %[[value2:.*]] = load i8*, i8** getelementptr inbounds (%struct._Z3Agg, %struct._Z3Agg* @_ZGRN6Struct3aggE_, i32 0, i32 0), align 8
// CHECK: call void @_Z3useiPKc(i32 3, i8* %[[value2]])
  use(4, ref.agg.x);
// CHECK: load %struct._Z6Struct*, %struct._Z6Struct** %{{.*}}, align 8
// CHECK: %[[value3:.*]] = load i8*, i8** getelementptr inbounds (%struct._Z3Agg, %struct._Z3Agg* @_ZGRN6Struct3aggE_, i32 0, i32 0), align 8
