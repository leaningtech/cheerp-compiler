// RUN: %clang_cc1 -triple %itanium_abi_triple -no-opaque-pointers -ffixed-point -S -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -no-opaque-pointers -ffixed-point -S -emit-llvm %s -o - -fpadding-on-unsigned-fixed-point | FileCheck %s
