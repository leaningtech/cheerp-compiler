...
// X32: @__block_descriptor_tmp = internal constant [[FULL_DESCRIPTOR_T:.*]] { i32 0, i32 20, i8* bitcast ([6 x i8]* [[STR1]] to i8*), i8* null }
...
// X32: @__block_descriptor_tmp{{.*}} = internal constant [[FULL_DESCRIPTOR_T]] { i32 0, i32 24, i8* bitcast ([11 x i8]* [[STR2]] to i8*), i8* null }
