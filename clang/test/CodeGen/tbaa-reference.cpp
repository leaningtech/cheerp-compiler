...
// CHECK: store %struct._Z1S* {{.*}}, %struct._Z1S** {{.*}}, !tbaa [[TAG_pointer:!.*]]

// Check loading of the reference parameter.
// CHECK: load %struct._Z1S*, %struct._Z1S** {{.*}}, !tbaa [[TAG_pointer]]
...
// CHECK: load %struct._Z1S*, %struct._Z1S** {{.*}}, !tbaa [[TAG_B_s:!.*]]
  return s;
}
