// RUN: %clang_cc1 -triple %itanium_abi_triple  -Wno-error-vec-elem-size -emit-llvm %s -o - | FileCheck %s
// RUN: %clang_cc1 -triple %itanium_abi_triple  -Wno-error-vec-elem-size -DEXT -emit-llvm %s -o - | FileCheck %s
