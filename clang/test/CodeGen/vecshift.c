...
// CHECK: [[t7:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i8> [[splat_splat]], [[t7]]
  vuc8 = i << vuc8;
// CHECK: [[t8:%.+]] = load i32, ptr{{( addrspace\(.\))?}} @i,
...
// CHECK: [[t9:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i8> [[splat_splat8]], [[t9]]
  vi8 = uc << vi8;
// CHECK: [[t10:%.+]] = load i8, ptr{{( addrspace\(.\))?}} @uc,
...
// CHECK: [[t11:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i32> [[splat_splat12]], [[t11]]
  vui8 = us << vui8;
// CHECK: [[t12:%.+]] = load i16, ptr{{( addrspace\(.\))?}} @us,
...
// CHECK: [[t13:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i32> [[splat_splat16]], [[t13]]
  vs8 = ui << vs8;
// CHECK: [[t14:%.+]] = load i32, ptr{{( addrspace\(.\))?}} @ui,
...
// CHECK: [[t15:%.+]] = load <8 x i16>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i16> [[splat_splat20]], [[t15]]
  vus8 = 1 << vus8;
// CHECK: [[t16:%.+]] = load <8 x i16>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[shl22:%.+]] = shl <8 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, [[t16]]

 vc8 = vc8 << vc8;
// CHECK: [[t17:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[t18:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i8> [[t17]], [[t18]]
  vi8 = vi8 << vuc8;
// CHECK: [[t19:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[t20:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[shprom:%.+]] = zext <8 x i8> [[t20]] to <8 x i32>
// CHECK: shl <8 x i32> [[t19]], [[shprom]]
  vuc8 = vuc8 << vi8;
// CHECK: [[t21:%.+]] = load <8 x i8>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[t22:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[sh_prom25:%.+]] = trunc <8 x i32> [[t22]] to <8 x i8>
// CHECK: shl <8 x i8> [[t21]], [[sh_prom25]]
  vus8 = vus8 << vui8;
// CHECK: [[t23:%.+]] = load <8 x i16>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[t24:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[sh_prom27:%.+]] = trunc <8 x i32> [[t24]] to <8 x i16>
// CHECK: shl <8 x i16> [[t23]], [[sh_prom27]]
  vui8 = vui8 << vs8;
// CHECK: [[t25:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[t26:%.+]] = load <8 x i16>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: [[sh_prom29:%.+]] = zext <8 x i16> [[t26]] to <8 x i32>
// CHECK: shl <8 x i32> [[t25]], [[sh_prom29]]

  vui8 <<= s;
// CHECK: [[t27:%.+]] = load i16, ptr{{( addrspace\(.\))?}} @s,
...
// CHECK: [[t28:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i32> [[t28]], [[splat_splat42]]
  vi8 <<= us;
// CHECK: [[t29:%.+]] = load i16, ptr{{( addrspace\(.\))?}} @us,
...
// CHECK: [[t30:%.+]] = load <8 x i32>, ptr{{( addrspace\(.\))?}} {{@.+}},
// CHECK: shl <8 x i32> [[t30]], [[splat_splat46]]
  vus8 <<= i;
// CHECK: [[t31:%.+]] = load i32, ptr{{( addrspace\(.\))?}} @i,
...
// CHECK: [[t34:%.+]] = load <8 x i16>, ptr{{( addrspace\(.\))?}} {{@.+}},
