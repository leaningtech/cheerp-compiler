...
// CHECK: call void @llvm.memcpy.{{.*}}(i8* align 4 bitcast (%struct.s1* @s to i8*), i8* align 4 bitcast (%struct.s1* @s to i8*), i64 132, i1 true)
// CHECK-NEXT: call void @llvm.memcpy.{{.*}}(i8* align 4 bitcast (%struct.s* getelementptr inbounds (%struct.s1, %struct.s1* @s, i32 0, i32 0) to i8*), i8* align 4 bitcast (%struct.s* @gs to i8*), i64 132, i1 true)
