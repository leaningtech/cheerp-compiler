...
long double testinc(_Atomic long double *addr) {
  ...
  // CHECK: call void @llvm.memset.p0i8.i32(i8* align 16 [[OLD_VALUE_VOID_ADDR]], i8 0, i32 16, i1 false)
  ...
  // CHECK: call void @llvm.memset.p0i8.i32(i8* align 16 [[NEW_VALUE_VOID_ADDR]], i8 0, i32 16, i1 false)
...
long double testassign(_Atomic long double *addr) {
  ...
  // CHECK: call void @llvm.memset.p0i8.i32(i8* align 16 [[STORE_TEMP_VOID_PTR]], i8 0, i32 16, i1 false)
