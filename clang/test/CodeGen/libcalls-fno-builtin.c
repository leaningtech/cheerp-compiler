// RUN: %clang_cc1 -triple %itanium_abi_triple -S -emit-llvm -fno-builtin -o - %s | FileCheck --check-prefixes=GLOBAL,CHECK %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -S -emit-llvm -fno-builtin-ceil -fno-builtin-copysign -fno-builtin-cos \
...
// RUN: %clang_cc1 -triple %itanium_abi_triple -S -O3 -fno-builtin -o - %s | FileCheck --check-prefix=ASM %s
// RUN: %clang_cc1 -triple %itanium_abi_triple -S -O3 -fno-builtin-ceil -o - %s | FileCheck --check-prefix=ASM-INDIV %s
