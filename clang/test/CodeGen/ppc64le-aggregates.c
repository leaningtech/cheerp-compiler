...
// CHECK-LABEL: @call_f1
// CHECK: %[[TMP:[^ ]+]] = load float, float* bitcast ([1 x float]* getelementptr inbounds (%struct.f1, %struct.f1* @global_f1, i32 0, i32 0) to float*), align 4
...
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %[[TMP2]], i8* align 4 bitcast ([9 x float]* getelementptr inbounds (%struct.f9, %struct.f9* @global_f9, i32 0, i32 0) to i8*), i64 36, i1 false)
...
// CHECK: %[[TMP:[^ ]+]] = load <3 x float>, <3 x float>* bitcast ([1 x <3 x float>]* getelementptr inbounds (%struct.v3f1, %struct.v3f1* @global_v3f1, i32 0, i32 0) to <3 x float>*), align 1
...
// CHECK: %[[TMP:[^ ]+]] = load [2 x <4 x float>], [2 x <4 x float>]* bitcast ([2 x <3 x float>]* getelementptr inbounds (%struct.v3f2, %struct.v3f2* @global_v3f2, i32 0, i32 0) to [2 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [3 x <4 x float>], [3 x <4 x float>]* bitcast ([3 x <3 x float>]* getelementptr inbounds (%struct.v3f3, %struct.v3f3* @global_v3f3, i32 0, i32 0) to [3 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [4 x <4 x float>], [4 x <4 x float>]* bitcast ([4 x <3 x float>]* getelementptr inbounds (%struct.v3f4, %struct.v3f4* @global_v3f4, i32 0, i32 0) to [4 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [5 x <4 x float>], [5 x <4 x float>]* bitcast ([5 x <3 x float>]* getelementptr inbounds (%struct.v3f5, %struct.v3f5* @global_v3f5, i32 0, i32 0) to [5 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [6 x <4 x float>], [6 x <4 x float>]* bitcast ([6 x <3 x float>]* getelementptr inbounds (%struct.v3f6, %struct.v3f6* @global_v3f6, i32 0, i32 0) to [6 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [7 x <4 x float>], [7 x <4 x float>]* bitcast ([7 x <3 x float>]* getelementptr inbounds (%struct.v3f7, %struct.v3f7* @global_v3f7, i32 0, i32 0) to [7 x <4 x float>]*), align 16
...
// CHECK: %[[TMP:[^ ]+]] = load [8 x <4 x float>], [8 x <4 x float>]* bitcast ([8 x <3 x float>]* getelementptr inbounds (%struct.v3f8, %struct.v3f8* @global_v3f8, i32 0, i32 0) to [8 x <4 x float>]*), align 16
