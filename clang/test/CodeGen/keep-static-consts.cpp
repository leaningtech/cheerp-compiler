...
// CHECK: @llvm.compiler.used = appending global [4 x i8*] [i8* bitcast ([4 x i8]* @_ZL7srcvers to i8*), i8* bitcast (i32* @b to i8*), i8* bitcast ([4 x i8]* @_ZL8srcvers2 to i8*), i8* bitcast (i32* @_ZL1N to i8*)], section "llvm.metadata"
