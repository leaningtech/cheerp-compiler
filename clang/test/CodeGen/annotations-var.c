...
// LOCAL-NEXT: call void @llvm.var.annotation(i8* [[T0]], i8* bitcast ([15 x i8]* @{{.*}}), i8* bitcast ({{.*}}), i32 33, i8* null)
// LOCAL-NEXT: [[T0:%.*]] = bitcast i32* [[LOCALVAR]] to i8*
// LOCAL-NEXT: call void @llvm.var.annotation(i8* [[T0]], i8* bitcast ([15 x i8]* @{{.*}}), i8* bitcast ({{.*}}), i32 33, i8* null)
}
...
// UNDEF-NEXT: call void @llvm.var.annotation(i8* [[T0]], i8* bitcast ([15 x i8]* @{{.*}}), i8* bitcast ({{.*}}), i32 52, i8* null)
}
