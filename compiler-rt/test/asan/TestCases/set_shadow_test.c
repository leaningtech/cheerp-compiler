...
// RUN: %run %t     --cheerp-arg=0x00 2>&1 | FileCheck %s -check-prefix=X00
// RUN: not %run %t --cheerp-arg=0xf1 2>&1 | FileCheck %s -check-prefix=XF1
// RUN: not %run %t --cheerp-arg=0xf2 2>&1 | FileCheck %s -check-prefix=XF2
// RUN: not %run %t --cheerp-arg=0xf3 2>&1 | FileCheck %s -check-prefix=XF3
// RUN: not %run %t --cheerp-arg=0xf5 2>&1 | FileCheck %s -check-prefix=XF5
// RUN: not %run %t --cheerp-arg=0xf8 2>&1 | FileCheck %s -check-prefix=XF8
